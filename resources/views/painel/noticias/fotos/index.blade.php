                                            ...
                                            <tr>
                                                <td class="text-center"
                                                    ...
                                                    <div style="text-align: left !important;position: absolute; bottom: 0px; left:0px; padding: 3px;background-color: rgba(255,255,255, 0.9); width: 100%;">
                                                        <a href="{{url('painel')}}/noticias/{{Route::input('id_not')}}/fotos/{{$item->FotCodigo}}/destaque"
                                                        ...
                                                        <a data-href="{{url('painel')}}/noticias/{{Route::input('id_not')}}/fotos/{{$item->FotCodigo}}/upload"
                                                ...
                                                <td style="vertical-align: middle">
                                                    <div class="form-group form{{$item->FotCodigo}}">
                                                        <input type="text" class="form-control legenda" maxlength="300"
                                                               ...
                                                               data-href="{{url('painel')}}/noticias/{{Route::input('id_not')}}/fotos/{{$item->FotCodigo}}/legenda">
                                                        <span class="help-block span{{$item->FotCodigo}} hidden"></span>
                                                    </div>
                                                </td>
                                                <td class="text-center" style="vertical-align: middle">
                                                    <a href="{{url('painel')}}/noticias/{{Route::input('id_not')}}/fotos/{{$item->FotCodigo}}/destroy?{{http_build_query(Input::all())}}"
