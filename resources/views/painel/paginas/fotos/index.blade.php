...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="{{getenv("PAINEL")}}/paginas/{{Route::input('id_pag')}}/fotos"> Fotos</a></li>
...
<section class="content">
    <div class="row">
        <div class="col-sm-12">
            <a data-href="{{getenv("PAINEL")}}/paginas/{{Route::input('id_pag')}}/fotos/multiploupload"
                                    ...
                                    <tr>
                                        <td class="text-center" style="vertical-align: middle; position: relative;">
                                            ...
                                            <div style="text-align: left !important;position: absolute; bottom: 0px; left:0px; padding: 3px;background-color: rgba(255,255,255, 0.9); width: 100%;">
                                                <a href="{{getenv("PAINEL")}}/paginas/{{Route::input('id_pag')}}/fotos/{{$item->FotCodigo}}/destaque"
                                                ...
                                                <a data-href="{{getenv("PAINEL")}}/paginas/{{Route::input('id_pag')}}/fotos/{{$item->FotCodigo}}/upload" class="btn btn-sm btn-primary  btn-upload-multiplo-modal" data-toggle="tooltip" data-placement="right" title="" data-original-title="Alterar foto"><i
                                        ...
                                        <td style="vertical-align: middle">
                                            <div class="form-group form{{$item->FotCodigo}}">
                                                <input type="text" class="form-control legenda" maxlength="300" value="{{$item->FotLegenda}}" name="legenda" id="legenda"
                                                       data-id="{{$item->FotCodigo}}" data-href="{{getenv("PAINEL")}}/paginas/{{Route::input('id_pag')}}/fotos/{{$item->FotCodigo}}/legenda">
                                                <span class="help-block span{{$item->FotCodigo}} hidden"></span>
                                            </div>
                                        </td>
                                        <td class="text-center" style="vertical-align: middle">
                                            <a href="{{getenv("PAINEL")}}/paginas/{{Route::input('id_pag')}}/fotos/{{$item->FotCodigo}}/destroy?{{http_build_query(Input::all())}}"
