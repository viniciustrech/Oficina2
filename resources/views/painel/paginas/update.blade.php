                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="box box-primary">
                            ...
                            <!-- form start -->
                            <form role="form"
                                  action="{{url('painel')}}/paginas/{{$item->PagCodigo}}/update?{{http_build_query(Input::all())}}"
                                  method="post">
                                <div class="box-body">
                                    <div class="col-sm-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" id="resumo" name="resumo"
                                                      placeholder="Resumo" rows="3">{{$item->PagResumo}}</textarea>
                                        </div>

                                        <div class="form-group">
                                            <label for="conteudo">Conteúdo</label>
                                            <textarea class="form-control ckeditor" id="conteudo" name="conteudo"
                                                      placeholder="Conteúdo" rows="10">{{$item->PagConteudo}}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <!-- /.box-body -->
