    ...
    <section class="section-secundarias">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="row">
                        @if(File::exists(public_path()."/upload/noticias/dest_" . $noticia->NotCodigo . ".jpg"))
                            <div class="col-sm-12">
                                <img src="{{asset("upload/noticias/dest_" . $noticia->NotCodigo . ".jpg")}}"
                            ...
                            <div class="col-sm-12" style="margin-top: 10px">
                                <div class="row light-gallery">
                                    @foreach($itens as $item)
                                        <div class="col-xs-6 col-sm-3 altura-fixa-auto"
                        ...
                        <div class="row" style="">
                            <div class="col-xs-12 text-center">
                                ...
                                <a class="btn btn-danger btn-xs"
                                   href="https://plus.google.com/share?url={{url("/noticia/".$noticia->NotCodigo."?".date("YmdHis"))}}"
